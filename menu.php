			...
			<div class="row">
				...
				<nav class="collapse navbar-collapse clearfix" role="navigation">
					<ul class="nav navbar-nav navbar-right">
						<li>
                       		<a href="index.php">หน้าแรก </i></a>
	                    </li>
						<li>
                       		<a href="news.php">ข่าวสาร </i></a>
                       	
	                    </li>
						<li class="dropdown active">
                       		<a href="menu.php" class="dropdown-toggle" data-toggle="dropdown">ระบบนำเข้าข้อมูล <i class="fa fa-angle-down"></i></a>
	                    ...
	                    <li>
                       		<a href="about.php">เกี่ยวกับเรา </i></a>
	                    </li>
            			<li><a href="contact.php">การติดต่อ</a></li>
                    </ul>
				</nav><!--/ Navigation end -->
		...
		<div class="parallax-overlay"></div>
			...
			<div class="banner-title-content">
	        	<div class="text-center">
		        	<h2>ระบบนำเข้าข้อมูล</h2>
		        	<ul class="breadcrumb">
			            <li> Home </li>
			            <li><a class="active"> ประเภทข้อมูล</a></li>
			            <li> About Us </li>
		          	</ul>
	          	</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
							<span class="feature-icon pull-left" ><i class="fa fa-book"></i></span>
							<div class="feature-content">
								<h5>ความรู้และการปฏิบัติการเชิงพื้นที่่</h5>
								<p>Bras urna felis accumsan at ultrde cesid posuere masa socis nautoque penat</p>
								<a data-aos="fade-right" data-aos-delay="900" href="menu.php" class="btn btn-primary">คลิก</a>
							</div>
						...
						<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
							...
							<div class="feature-content">
								<h5>นวัตกรรมเพื่อการจัดการภัยพิบัติ</h5>
					...
					<div class="row">
						...
						<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
							<span class="feature-icon pull-left" ><i class="fa fa-paper-plane"></i></span>
							<div class="feature-content">
								<h5>กิจกรรม</h5>
								<p>Consectetur adipisicing elit sed do eiusmod tempor incididunt ut</p>
								<a data-aos="fade-right" data-aos-delay="900" href="menu.php" class="btn btn-primary">คลิก</a>
					...
					<div class="row">
						<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
							<span class="feature-icon pull-left" ><i class="fa fa-mortar-board"></i></span>
							<div class="feature-content">
								<h4>หลักสูตรอบรม</h4>
								<p>Bras urna felis accumsan at ultrde cesid posuere masa socis nautoque penat</p>
								<a data-aos="fade-right" data-aos-delay="900" href="menu.php" class="btn btn-primary">คลิก</a>
						...
						<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
							<span class="feature-icon pull-left" ><i class="fa fa-group"></i></span>
							<div class="feature-content">
								<h5>ความร่วมมือระหว่างหน่วยงาน </h5>
								<p>High Life narwhal, banh mi PBR single-origin coffee Odd Future actually aliqua</p>
								<a data-aos="fade-right" data-aos-delay="900" href="menu.php" class="btn btn-primary">คลิก</a>
							</div>
						</div><!--/ End first featurebox -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 footer-widget footer-about-us">
							...
							<li>We are a awward winning multinational company. We believe in quality and standard worldwide.</li>
							<li><strong>Address: </strong>คณะการบัญชีและการจัดการ, มหาวิทยาลัยมหาสารคาม</li>
							<li><strong>Email: </strong>info@msu.acth</li>
							<li><strong>Phone No.</strong>+(785) 238-4131</li>
