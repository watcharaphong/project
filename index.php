			...
			<div class="row">
				...
				<nav class="collapse navbar-collapse clearfix" role="navigation">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
                       		<a href="menu.php" >ระบบนำเข้าข้อมูล </i></a>
						...
						<div class="col-md-12">
							<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay=".5s">
								<div class="service-content text-center">
									...
									<h3>ข่าวสาร</h3>
									<a data-aos="fade-right" data-aos-delay="900" href="news.php" class="btn btn-primary">คลิก</a>								</div>
							...
							<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay="1.1s">
								<div class="service-content text-center">
									...
									<a data-aos="fade-right" data-aos-delay="900" href="#" class="btn btn-primary">คลิก</a>								</div>
