			...
			<div class="row">
				...
				<div class="navbar-header">
				    ...
				    <div class="navbar-brand">
					    <a href="index.php">
						<img class="img-responsive" src="images/msu.png"  alt="logo" height="350" width="250">
					    </a> 
				    </div>                   
				</div><!--/ Logo end -->
				<nav class="collapse navbar-collapse clearfix" role="navigation">
					<ul class="nav navbar-nav ">
						<li class="dropdown active">
                       		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>หน้าแรก</h4> <i class="fa fa-angle-down"></i></a>
						...
						<li class="dropdown">
                       		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>จดหมายข่าว </h4>  <i class="fa fa-angle-down"></i></a>
                       		<div class="dropdown-menu">
								<ul>
						...
						<li class="dropdown">
                       		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>Portfolio</h4> <i class="fa fa-angle-down"></i></a>
                       		<div class="dropdown-menu">
								<ul>
	                    ...
	                    <li class="dropdown">
                       		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>Pages</h4> <i class="fa fa-angle-down"></i></a>
                       		<div class="dropdown-menu">
								<ul>
	                    ...
	                    <li class="dropdown">
                       		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>Blog </h4><i class="fa fa-angle-down"></i></a>
                       		<div class="dropdown-menu">
								<ul>
	                    ...
	                    <li class="dropdown">
                       		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><h4>เกี่ยวกับเรา</h4>  <i class="fa fa-angle-down"></i></a>
                       		<div class="dropdown-menu">
								<ul>
